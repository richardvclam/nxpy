...
namespace nl {
	...
	uint64_t bitmap::compressed_size() const {
		uint64_t src = 4 + reinterpret_cast<uint64_t>(m_data);
		return src;
		//const char * src = 4 + reinterpret_cast<char const *>(m_data);
